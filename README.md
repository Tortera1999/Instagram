...
1. Add camera option
2. Improve on UI and make it look more like Instagram

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://media.giphy.com/media/3ohs4fXusManx4AR1K/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- Had problems accessing the data in the database
- Had problems implementing the tab bar
